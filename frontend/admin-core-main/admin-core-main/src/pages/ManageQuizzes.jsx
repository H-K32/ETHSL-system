              ...
              {quizzes.map((q) => (
                <tr key={q.id}>
                  <td>
                    ...
                    {q.level && !q.lesson && (q.quiz_type === "placement" || q.quiz_type === "lesson") && "Placement Test"}
                    {q.level && !q.lesson && q.quiz_type === "final" && "Level Final Quiz"}
                  </td>
              ...
              {levels
                .filter((l) =>
                  form.quiz_type === "placement"
                    ? ["intermediate", "advanced"].includes(l.name)
                    : true
                )
                .map((l) => (
