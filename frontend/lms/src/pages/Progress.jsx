    ...
    <div className="max-w-5xl mx-auto z-10 relative progress-app-container">
      ...
      <div className="progress-hero mb-10 text-center md:text-left">
        ...
        <p className="progress-subtitle text-sm md:text-base font-sans font-medium text-forest-700 max-w-2xl leading-relaxed">
          Track your journey on the language path, monitor your learning habits, and record advanced academic achievements.
        </p>
      </div>
        ...
        <div className="flex items-center space-x-5">
          ...
          <div>
            ...
            {!progress.placement_passed && (
              <p className="text-xs font-sans text-amber-700 font-semibold mt-1">⚠️ You must complete the placement exam to unlock full content.</p>
            )}
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-bone-50 rounded-xl border border-bone-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-serif text-sm font-bold text-forest-900">Chapter 1: Basic Writing</span>
                  <span className="font-mono text-xs text-sienna-600 font-extrabold">{completedList.includes('lvl-1') ? '100% Completed' : '0%'}</span>
                </div>
              ...
              <div className="p-4 bg-bone-50 rounded-xl border border-bone-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-serif text-sm font-bold text-forest-900">Chapter 2: Advanced Speaking</span>
                  <span className="font-mono text-xs text-sienna-600 font-extrabold">{completedList.includes('lvl-2') ? '100% Completed' : (completedList.includes('lvl-1') ? '40% In Progress' : '0%')}</span>
                </div>
                <div className="h-2 bg-bone-200 rounded-full overflow-hidden border border-bone-300">
              ...
              <div className="p-4 bg-bone-50 rounded-xl border border-bone-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-serif text-sm font-bold text-forest-900">Chapter 3: Master Editor</span>
                  <span className="font-mono text-xs text-sienna-600 font-extrabold">{completedList.includes('lvl-3') ? '100% Completed' : (completedList.includes('lvl-2') ? '20% In Progress' : '0%')}</span>
                </div>
                <div className="h-2 bg-bone-200 rounded-full overflow-hidden border border-bone-300">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-bone-50 rounded-xl border border-bone-200">
                ...
                <span className="font-mono text-xs font-bold text-forest-950">{progress.total_quiz_attempts} times</span>
              </div>

              <div className="flex justify-between items-center p-3 bg-bone-50 rounded-xl border border-bone-200">
                <span className="font-sans text-xs font-semibold text-forest-750">Passed Quizzes</span>
                <span className="font-mono text-xs font-bold text-emerald-700">{progress.quizzes_passed} quizzes</span>
              </div>
              ...
              <div className="flex justify-between items-center p-3 bg-bone-50 rounded-xl border border-bone-200">
                ...
                <span className="font-mono text-xs font-bold text-sienna-600">
                  {progress.total_quiz_attempts > 0 
                    ? Math.round((progress.quizzes_passed / progress.total_quiz_attempts) * 105) / 1.05
                    : 0}%
                </span>
              </div>
            </div>
      ...
      <div className="achievements-card bg-white p-6 rounded-2xl border border-bone-300 shadow-xs mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 bg-bone-50 rounded-xl border border-bone-250 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-serif text-sm font-bold text-forest-900">First Writer</h4>
              <p className="text-[10px] font-sans font-medium text-forest-650 mt-1 leading-relaxed">Successfully completed the first Sienna chapter.</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-bone-50 rounded-xl border border-bone-250 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-serif text-sm font-bold text-forest-900">Academic Assessment</h4>
              <p className="text-[10px] font-sans font-medium text-forest-650 mt-1 leading-relaxed">Completed placement exam to determine language level.</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-bone-50 rounded-xl border border-bone-250 flex items-start gap-3">
            <span className="text-xl">🔥</span>
            <div>
              <h4 className="font-serif text-sm font-bold text-forest-900 font-serif">Dedicated Learner</h4>
              <p className="text-[10px] font-sans font-medium text-forest-650 mt-1 leading-relaxed">Maintained a 7-day active study streak.</p>
            </div>
          </div>
        </div>
      </div>
